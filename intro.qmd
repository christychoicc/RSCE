...
[![Electromagnetic Spectrum and Satellite Sensor Capture Range (Source: [ESRI](https://learn.arcgis.com/en/projects/explore-imagery-spectral-resolution/))](images/w1_images/electromagnetic_spectrum.png){alt="Remote Sensing Resolutions (Source: NASA EARTHDATA)"}](https://learn.arcgis.com/en/projects/explore-imagery-spectral-resolution/)
:::
...
Different combinations of multi-spectral bands to examine relationship between the bands, to highlight physical land features. It is commonly used to evaluate **brightness**, **greenness** and **wetness**.
...
Comparing two Sentinel-2 tasseled cap transformed imagery that is adjusted for brightness, greenness and wetness between August and December 2025. Although there is no obvious land cover change, the ... have showed the
