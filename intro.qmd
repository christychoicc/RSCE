...
The frequency of a sensor's revisit in capturing the same observation area. The temporal resolution measurement period can vary from 1 to 16 days depending on the platform [@earthsciencedatasystems2025]. Particularly in environmental monitoring where measurements are time sensitive.
