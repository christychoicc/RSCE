...
Moving beyond, here will use a combination of bands for NDVI, to highlight healthy vegetation. The following equation is applied:
...
PCA is often used to compress multispectral bands into fewer, uncorrelated components while retaining most of the useful information. Our summary of 8 spectral bands and 8 texture variables shows:
