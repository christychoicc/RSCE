...
This section will build up the knowledge of GEE from last chapter and focus on using machine learning techniques for land use and land cover change (LULCC) with classification.
...
In this case, we will look at 6 land use classes: urban_low, water, urban_high, grass, bare_earth, forest

Divided into 70% training and 30% testing datasets
...
| Random Forest (RF) | Supervised | Generate numerous decision trees by randomly sampling variables and training datasets (usually 20) | High efficiency and accuracy, |  | Land cover (vegetation, urban, barren) environmental monitoring and land management applications |
...
The application of machine learning is widely used among remote sensing analysis, typically LULCSS, but also for other.... such as NDVI.
...
::: {layout-ncol="1"}
![Time Series Data NDI](images/w7_images/timeseriesdata.jpg){alt="RF Pixel"}
:::
