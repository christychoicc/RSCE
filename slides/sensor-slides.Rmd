...
Launched in 5 December 2024, reestablished a two-satellite constellation orbiting 180° apart for extensive worldwide coverage by May 2025 with improved features. SAR actively senses the microwaves from the Earth's surface, distincting dark features visibly, making it uniquely reliable for the continuous monitoring for modern applications.
...
.pull-left-4[
#### Ice
* **Role**: Ice Classification, Iceberg Information

* **Identification**: Type, Salinity, Roughness, Thickness, Size, Density, Orientation, Location, Drift

* **Navigation**: Coast Guards, Navies, Ships in Ice-Covered Zones
...
* **Cooperative System**: Uses AIS (Automatic Identification System) Onboard to Trace and Identify Ships, Reporting Identity and Location
...
* **Prosecution**: Oil Detection from Illegal discharges, Oil Spills Spread, Naturally Seepage correlated with AIS information

]

.pull-right-4[
#### Marine Waves and Winds

* **Weather Prediction**: Storm and Cyclone Monitoring

* **Coastal**: Ocean Currents and Sea Surface Winds
