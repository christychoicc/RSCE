...
"All heat deaths are preventable" [@nyc.gov2019]. The OneNYC uses the Heat Vulnerability Index to identify neighborhoods that are more at risk following extreme heat. The risks are not evenly distributed across the city, where South Bronx, Central Brooklyn and Upper Manhattan are highlighted as the city's most heat vulnerable neighborhoods.
...
-   Source: [MODIS](https://terra.nasa.gov/about/terra-instruments/modis) , @zhou2019, @solecki2015, @hantson2013, @maclachlan2021
