...
"All heat deaths are preventable" @nyc.gov. The OneNYC uses the Heat Vulnerability Index to identify neighborhoods that are more at risk following extreme heat. The risks are not evenly distributed across the city, where South Bronx, Central Brooklyn and Upper Manhattan are highlighted as the city's most heat vulnerable neighborhoods.
