...
This section will be focused on using Google Earth Engine to explore land surface temperature (LST) and compare how thermal patterns vary across different climates, spatial scales and satellite products. What stood out most to me was that temperature mapping is not only about identifying hot areas, but also about understanding how resolution, cloud cover and scale shape what can actually be observed.

Building upon the early chapters of discussing Urban Heat Island Effect in [Policy](https://christychoicc.github.io/RSCE/policy.html), this section will focus on land surface temperature......
