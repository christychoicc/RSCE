...
-   **F1 score**: The harmonic mean between precision and recall, ranging from 0 to 1 (closer to 1 indicates better performance)
    ...
    A workflow I will adopt: Class Definition → Pre-processing → Train Test Split or Spatial Cross Validation → Pixel Assignment (unmix and constrained fractions ; OBIA) → Accuracy Assessment
    :::
