...
::: {layout-ncol="1"}
![GEE Interface (Source: [Google Earth Engine](https://developers.google.com/earth-engine/tutorials/community/beginners-cookbook))](images/w6_images/gee_platform.png)
:::
...
::: {layout-ncol="1"}
![Reducing (Source: [GEE Tutorials](https://google-earth-engine.com/Interpreting-Image-Series/Filter-Map-Reduce/) )](images/w6_images/ee.reducer.median.png)
:::
...
: Source: [Amani et. al., 2020](https://www.researchgate.net/publication/344056372_Google_Earth_Engine_Cloud_Computing_Platform_for_Remote_Sensing_Big_Data_Applications_A_Comprehensive_Review), [Gorelick et.al., 2017](https://www.sciencedirect.com/science/article/pii/S0034425717302900), [CASA0023](https://andrewmaclachlan.github.io/CASA0023/)
...
::: {layout-ncol="1"}
![GEE Workflow (Source: [Amani et. al., 2020](https://www.researchgate.net/publication/344056372_Google_Earth_Engine_Cloud_Computing_Platform_for_Remote_Sensing_Big_Data_Applications_A_Comprehensive_Review))](images/w6_images/gee_usage.gif){#reference alt="GEE Workflow"}
:::
...
::: {layout-ncol="1"}
![GEE Applications (Source: [Amani et. al., 2020](https://www.researchgate.net/publication/344056372_Google_Earth_Engine_Cloud_Computing_Platform_for_Remote_Sensing_Big_Data_Applications_A_Comprehensive_Review))](images/w6_images/gee_applications.png)
:::

::: {layout-ncol="1"}
[![Remote Sensing Products Usage in GEE (Source [Velastegui-Montoya et.al, 2023](https://www.mdpi.com/2072-4292/15/14/3675))](images/w6_images/satellite_sensors_most_mentioned_in_publications_gee_2011_22.jpg)](https://www.mdpi.com/2072-4292/15/14/3675)
:::
...
Despite, it has also raise my awareness of limitations. GEE is implying a noncommercial quota tier from April 2026, capping free Earth Engine Compute Units (EECUs) on a monthly basis, which may possibly limit intensive workflows as a student user. I also found the fact that GEE does not support markdown style cell-by-cell execution makes catching error harder. Although GEE's cloud computing capabilities makes it a very effective tool for remotely sensing analysis, but it also means that it is entirely dependent on stable internet connection, which may ocassionally be a problem.
